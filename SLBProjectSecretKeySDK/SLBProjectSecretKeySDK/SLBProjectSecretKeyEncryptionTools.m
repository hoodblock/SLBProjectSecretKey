//
//  SLBProjectSecretKeyEncryptionTools.m
...
@implementation SLBProjectSecretKeyEncryptionTools
...
+ (SecKeyRef)addPublicKey:(NSString *)key{
    ...
    data = [SLBProjectSecretKeyEncryptionTools stripPublicKeyHeader:data];
    if(!data){
        return nil;
    }
...
+ (SecKeyRef)addPrivateKey:(NSString *)key{
    ...
    // This will be base64 encoded, decode it.
    NSData *data = base64_decode(key);
    data = [SLBProjectSecretKeyEncryptionTools stripPrivateKeyHeader:data];
    if(!data){
        return nil;
    }
...
//    NSData *data = [SLBProjectSecretKeyEncryptionTools encryptData:[str dataUsingEncoding:NSUTF8StringEncoding] privateKey:privKey];
...
//        return nil;
//    }
//    SecKeyRef keyRef = [SLBProjectSecretKeyEncryptionTools addPrivateKey:privKey];
//    if(!keyRef){
//        return nil;
//    }
//    return [SLBProjectSecretKeyEncryptionTools encryptData:data withKeyRef:keyRef isSign:YES];
//}
...
+ (NSString *)rsaDecryptString:(NSString *)string keyString:(NSString *)keyString{
    NSData *data = [[NSData alloc] initWithBase64EncodedString:string options:NSDataBase64DecodingIgnoreUnknownCharacters];
    data = [SLBProjectSecretKeyEncryptionTools rsaDecryptData:data keyString:keyString];
    NSString *ret = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
    return ret;
}
...
+ (NSData *)rsaDecryptData:(NSData *)data keyString:(NSString *)keyString{
    ...
    SecKeyRef keyRef = [SLBProjectSecretKeyEncryptionTools addPrivateKey:keyString];
    if(!keyRef){
        return nil;
    }
    return [SLBProjectSecretKeyEncryptionTools decryptData:data withKeyRef:keyRef];
}
...
+ (NSString *)rsaEncryptString:(NSString *)string keyString:(NSString *)keyString{
    NSData *data = [SLBProjectSecretKeyEncryptionTools rsaEncryptData:[string dataUsingEncoding:NSUTF8StringEncoding] keyString:keyString];
    NSString *ret = base64_encode_data(data);
    return ret;
}
...
+ (NSData *)rsaEncryptData:(NSData *)data keyString:(NSString *)keyString{
    ...
    SecKeyRef keyRef = [SLBProjectSecretKeyEncryptionTools addPublicKey:keyString];
    if(!keyRef){
        return nil;
    }
    return [SLBProjectSecretKeyEncryptionTools encryptData:data withKeyRef:keyRef isSign:NO];
}

//+ (NSString *)decryptString:(NSString *)str publicKey:(NSString *)pubKey{
//    NSData *data = [[NSData alloc] initWithBase64EncodedString:str options:NSDataBase64DecodingIgnoreUnknownCharacters];
//    data = [SLBProjectSecretKeyEncryptionTools decryptData:data publicKey:pubKey];
//    NSString *ret = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
//    return ret;
//}
//
...
//        return nil;
//    }
//    SecKeyRef keyRef = [SLBProjectSecretKeyEncryptionTools addPublicKey:pubKey];
//    if(!keyRef){
//        return nil;
//    }
//    return [SLBProjectSecretKeyEncryptionTools decryptData:data withKeyRef:keyRef];
